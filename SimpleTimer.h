...
public:
    ...
    int setInterval(long initial_delay, long interval_ms, timer_callback func);

    // call function f once after d milliseconds
    int setTimeout(long d, timer_callback func);

    // call function f every d milliseconds for n times
    int setTimer(long initial_delay, long interval_ms, timer_callback func, int n);
